...
public class Day1Tests
{
    ...
    public void Part1_ShouldReturnInteger_WhenEnumberableIsInteger(int[] values, int expected)
    {
        // Act
    ...
    public void Part2__ShouldReturnInteger_WhenEnumberableIsInteger(int[] values, int expected)
    {
        // Act
